...
public class SysRoleController {
	...
	@OperLog(title = "角色管理-添加角色", businessType = BusinessType.INSERT)
	@PostMapping
	...
	@OperLog(title = "角色管理-更新角色", businessType = BusinessType.UPDATE)
	@PutMapping
	...
	@OperLog(title = "角色管理-删除角色", businessType = BusinessType.DELETE)
	@DeleteMapping("{id}")
	 ...
	 * @return {@code true} 添加成功，{@code false} 添加失败
	 */
	@SaCheckPermission(value = "sys:role:user:save")
	@OperLog(title = "角色管理-添加用户角色关系", businessType = BusinessType.INSERT)
	 ...
	 */
	@SaCheckPermission(value = "sys:role:user:remove")
	@OperLog(title = "角色管理-移除用户角色关系", businessType = BusinessType.DELETE)
	 ...
	 */
	@SaCheckPermission(value = "sys:role:menu:save")
	@OperLog(title = "角色管理-保存角色菜单关系", businessType = BusinessType.INSERT)

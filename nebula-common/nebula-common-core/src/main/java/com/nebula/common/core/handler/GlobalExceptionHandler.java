...
public class GlobalExceptionHandler {
	...
	public R<String> notPermissionExceptionHandler(HttpServletRequest request, Exception e) {
		log.error("{} 权限异常:{}", request.getContextPath(), e.getMessage(), e);
		return R.<String>fail().setMsg("此操作无权限，请联系管理员");
	}
}
